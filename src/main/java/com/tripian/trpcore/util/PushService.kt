...
//
///**
// * Created by semihozkoroglu on 30.08.2021.
// */
...
//        val data = Bundle()
//
//        if (remoteMessage.data.containsKey("poiId")) {
//            // new offer olursa poiId + offerId exp:845454 - cancel olmasi durumu poiId gelmiyor netlestirilecek
//            data.putInt("poiId", remoteMessage.data["poiId"]!!.toInt())
//        }
//
//        if (remoteMessage.data.containsKey("offerId")) {
//            // offerId tek basina geliyor ise sadece cancelled offer durumunda oluyor exp:18
//            data.putLong("offerId", remoteMessage.data["offerId"]!!.toLong())
//        }
//
