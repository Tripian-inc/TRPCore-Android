...
class CheckBoxView @JvmOverloads constructor(
    ...
    private var imCheck: ImageView
    private var isChecked = false

    private var onCheckedListener: ((Boolean) -> Unit)? = null

    init {
        inflater.inflate(R.layout.view_check_new, this, true)
    ...
    fun check(isChecked: Boolean, slient: Boolean = false) {
        ...
        if (isChecked) {
            ...
            tvText.setTextColor(ContextCompat.getColor(context, R.color.text_primary))
        }
    }
